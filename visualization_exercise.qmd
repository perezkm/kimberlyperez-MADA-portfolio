...
nps_clean$year<-as.numeric(as.character(nps_clean$year))
...
nps_clean %>% ggplot() +geom_line(
  ...
  scale_y_reverse(breaks=seq(50,1,-25), limits=c(62,0)) + 
  scale_x_continuous(breaks=seq(1925,2000,25),limits=c(1904,2016)) +
  xlab("Year") + 
  ylab("Rank") +
